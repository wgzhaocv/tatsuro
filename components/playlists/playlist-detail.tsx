...
import { PlaylistDetailSkeleton } from "./playlist-detail-skeleton";
import { PlaylistHeaderActions } from "./playlist-header-actions";
import { SharePlaylistMenu } from "./share-playlist-menu";
              ...
              <div className="mt-5 flex flex-col items-start gap-2.5 sm:mt-6 sm:flex-row sm:flex-wrap sm:items-center">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <OfflineSwitch
                    ...
                    label={playlist.name}
                  />
                  <SharePlaylistMenu playlistId={playlist.id} title={name} />
