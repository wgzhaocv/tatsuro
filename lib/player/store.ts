...
// Persist writes serialize the whole queue + history — debounced, shared
// wrapper (a volume drag fires a setter per pointer move).
const debouncedLocalStorage = createDebouncedLocalStorage();
